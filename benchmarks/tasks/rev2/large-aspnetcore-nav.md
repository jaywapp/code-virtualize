# large-aspnetcore NAV task card (rev2)

corpus: `dotnet/aspnetcore` (`main`) @ `7cc41c501115f365c0b7f1b50ebaa134a328f0e5` (MIT).
This card holds the input for the [protocol.md Revision 2](../../protocol.md#r2-2-task)
NAV composite (N1 DECL, N2 SRC, N3 REF, N4 RECOVERY). Per R2-1/R2-9 it does not contain
corpus source text, file paths, line numbers, or answers.
...
|---|---|---|---|
| 0 | tuning | `AdditionalDocumentNamesResolver.ResolveDocumentNames` | (none) |
| 1 | held-out candidate | `Microsoft.AspNetCore.Components.BasePathTest.GetHref` | `TestRenderer, int` |
| 2 | held-out candidate | `FormatterWebSite.Controllers.UnionsController.EchoPetWithClassifier` | `UnionPetWithClassifier` |
| 3 | held-out candidate | `Microsoft.Extensions.DependencyInjection.XmlDataContractSerializerMvcOptionsSetupTest.DoesNotOverrideExistingMapping` | (none) |
| 4 | held-out candidate | `Microsoft.AspNetCore.Analyzers.Infrastructure.RoutePattern.RoutePatternHelpers.CreateMissingToken` | `RoutePatternKind` |
| 5 | held-out candidate | `Microsoft.AspNetCore.Http.HttpResults.TypedResultsTests.LocalRedirect_WithNullStringUrl_ThrowsArgException` | (none) |
| 6 | held-out candidate | `Microsoft.AspNetCore.Mvc.Infrastructure.JsonResultExecutorTestBase.GetWrittenBytes` | `HttpContext` |
| 7 | held-out candidate | `Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure.DynamicPageEndpointSelectorCache.EnsureDataSource` | `int` |
| 8 | held-out candidate | `Microsoft.AspNetCore.Mvc.RazorPages.PageModel.OnPageHandlerSelected` | `PageHandlerSelectedContext` |
| 9 | held-out candidate | `Microsoft.AspNetCore.Certificates.Generation.CertificateManager.CertificateManagerEventSource.UnixOpenSslCertificateDirectoryOverridePresent` | `string` |
| 10 | held-out candidate | `Microsoft.AspNetCore.Server.Kestrel.Core.Internal.LoggerExtensions.DeveloperCertificateNotTrusted` | `ILogger<KestrelServer>` |
| 11 | held-out candidate | `Microsoft.AspNetCore.Components.Analyzers.InvokeAsyncOfObjectAnalyzer.GetReceiverType` | `IInvocationOperation` |
