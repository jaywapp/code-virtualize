# medium-quartznet NAV task card (rev2)
...
|---|---|---|---|
| 0 | tuning | `Quartz.Tests.Unit.Impl.AdoJobStore.UnmigratedSchemaRefusalSqliteTest.TheMigrationsTheMessageNamesAreTheOnesThatMakeTheSchemaStart` | (none) |
| 1 | held-out candidate | `Quartz.Tests.Unit.Simpl.RAMJobStoreTest.SampleSignaler.NotifySchedulerListenersJobDeleted` | `JobKey, CancellationToken` |
| 2 | held-out candidate | `Quartz.Tests.Unit.Impl.AdoJobStore.FakeParameterCollection.GetEnumerator` | (none) |
| 3 | held-out candidate | `Quartz.Tests.Unit.QuartzHostedServiceTests.CreateHostedService` | `Lifetime, ISchedulerFactory, bool, bool, bool` |
| 4 | held-out candidate | `Quartz.Tests.Unit.SchedulerListenerTest.Qtz205ScheListener.JobScheduled` | `IScheduler, ITrigger, CancellationToken` |
| 5 | held-out candidate | `Quartz.Tests.Unit.Impl.AdoJobStore.AdoJobStoreBaseTest.DeadNode` | (none) |
| 6 | held-out candidate | `Quartz.Benchmark.Competitors.Completion.Disarm` | (none) |
| 7 | held-out candidate | `Quartz.IListenerManager.GetJobListener` | `string` |
| 8 | held-out candidate | `Quartz.Tests.Integration.Impl.AdoJobStore.ClusteredSerialJobTestBase.SerialJob.RecordPeak` | `int` |
| 9 | held-out candidate | `Quartz.Tests.Unit.Xml.XmlSchedulingDataProcessorTest.APreferredNodeOfStarIsAnAutomaticPin` | (none) |
| 10 | held-out candidate | `Quartz.Tests.Unit.Simpl.MicrosoftDependencyInjectionJobFactoryTest.TenantSettingJobFactory.ConfigureScope` | `IServiceScope, TriggerFiredBundle, IScheduler` |
| 11 | held-out candidate | `Quartz.Tests.Unit.Simpl.BuiltInTriggerSerializerDerivationTest.AssertRoundTripped` | `ReportTrigger` |
